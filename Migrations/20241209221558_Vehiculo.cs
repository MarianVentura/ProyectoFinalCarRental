        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TitularTarjeta = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    FechaVencimiento = table.Column<DateTime>(type: "datetime2", nullable: true),
                    TipoTarjeta = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    CodigoSeguridad = table.Column<string>(type: "nvarchar(4)", maxLength: 4, nullable: true),
                    BancoTransferencia = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ...
                    NombreTitularTransferencia = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReservaDetalles", x => x.ReservaDetalleId);
                    table.ForeignKey(
                        name: "FK_ReservaDetalles_MetodosPago_MetodoPagoId",
                        column: x => x.MetodoPagoId,
                        principalTable: "MetodosPago",
                        principalColumn: "MetodoPagoId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReservaDetalles_MetodoPagoId",
